    ...
    <div className="py-4">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {/* Badges — purpose on all screens; Unsecured + remaining months desktop only */}
          ...
          <div className="mt-2.5">
            ...
            <div className="mt-1 flex items-center justify-between text-[11px] text-content-secondary">
              {/* Desktop: full repaid breakdown */}
              <span className="hidden sm:inline">
                {formatCurrency(repaid)} repaid of {formatCurrency(account.sanctionedAmount)} · {progress}%
              </span>
              {/* Mobile: percentage + months left */}
              <span className="sm:hidden">{progress}% repaid</span>
              <span className="sm:hidden">{monthsLeft} mo. left</span>
            </div>
          </div>
