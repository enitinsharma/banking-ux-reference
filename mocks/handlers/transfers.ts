...
const recurringTransfers: RecurringTransfer[] = [
  { id: 'rec-001', beneficiaryId: 'ben-001', amount: 5000, frequency: 'monthly', nextDate: '2026-06-01', active: true, remarks: 'Monthly allowance' },
  { id: 'rec-002', beneficiaryId: 'ben-004', amount: 2000, frequency: 'monthly', nextDate: '2026-06-15', active: false, remarks: 'Rent contribution' },
];
