...
const history: PointsHistoryEntry[] = [
  { id: 'pts-001', description: 'Amazon.in purchase', points: 32, type: 'earned', date: '2026-05-02', transactionId: 'txn-002' },
  { id: 'pts-002', description: 'Salary credit bonus', points: 850, type: 'earned', date: '2026-05-01', transactionId: 'txn-001' },
  { id: 'pts-003', description: 'Cashback redemption', points: -500, type: 'redeemed', date: '2026-04-30' },
  { id: 'pts-004', description: 'BigBasket purchase', points: 19, type: 'earned', date: '2026-05-10', transactionId: 'txn-010' },
  { id: 'pts-005', description: 'Birthday bonus', points: 200, type: 'earned', date: '2026-04-15' },
  { id: 'pts-006', description: 'Travel voucher redemption', points: -1000, type: 'redeemed', date: '2026-04-01' },
];
